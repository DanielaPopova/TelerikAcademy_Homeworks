...
SELECT CONCAT(FirstName, ' ', LastName) AS [Full Name], a.AddressText AS [Address]
...
SELECT CONCAT(e.FirstName, ' ', e.LastName) AS [Employee Name], CONCAT(m.FirstName, ' ', m.LastName) AS [Manager Name], a.AddressText AS [Address]
FROM Employees e
	JOIN Employees m
		ON e.ManagerID = m.EmployeeID
	JOIN Addresses a
...
AND (e.HireDate BETWEEN '1995/01/01' AND '2005/01/01')) --(1/1/1995 AND 1/1/2005) exclusive 2005 - result 25 rows
...
AND (YEAR(e.HireDate) BETWEEN 1995 AND 2005)) --inclusive 2005 - result 28 rows